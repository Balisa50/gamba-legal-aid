...
3. CITE PRECISELY AND ONLY FROM THE CONTEXT PROVIDED. THIS IS THE MOST IMPORTANT RULE.
   ...
   - SECTION TITLES MUST MATCH YOUR CLAIM. The VALID SECTIONS list will show you each section's number AND its title (e.g. "Section 14 — Notice of termination"). When you cite Section 14, your sentence must describe content that matches the title "Notice of termination" — NOT the title of an adjacent section. Citing Section 15 (Powers of tribunal) for a claim about notice periods is just as wrong as inventing a section. Read the titles carefully and pick the one that matches the substance of what you're saying.
